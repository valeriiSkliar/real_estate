...
class DeeplTranslator implements TranslatorInterface
{
    private $apiKey;
    private $client;
    private $baseUrl = 'https://api.deepl.com/v2/translate';
    ...
    {
        $this->apiKey = Yii::$app->params['deepl_translation_api_key'] ?? null;
    ...
    public function setSourceLanguage($sourceLang): void
    {
