...
/**
 * SupportMessagesSearch represents the model behind the search form of `app\models\SupportMessages`.
 */
class SupportMessagesSearch extends SupportMessages
{
