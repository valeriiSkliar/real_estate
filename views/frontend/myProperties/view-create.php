...
<div class="mobile-advertisement-create">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label class="control-label">Загрузите фотографии (до 10 шт.)</label>
...
<div class="fixed-bottom bg-white border-top p-3 action-bar">
    <div class="container">
        <div class="row g-2">
            <div class="col-6">
                <button type="button" class="btn btn-outline-secondary w-100" onclick="history.back()">Отмена</button>
            </div>
            <div class="col-6">
