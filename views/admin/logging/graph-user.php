...
$this->title = 'График добавления пользователей';
...
<script>
    window.addEventListener("load", (event) => {
        Highcharts.chart('container', {
            ...
            title: {
                text: 'График добавления новых пользователей' // Add your graph's title
            },
            ...
            yAxis: {
                title: {
                    text: 'Количество новых пользователей' // Don't forget to name y-Axis too
                }
            },
            series: [{
